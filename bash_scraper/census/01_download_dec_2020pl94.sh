...
# Source: https://github.com/censusreporter/census-postgres-scripts/blob/master/02_download_dec_2020_pl94.sh
# Download Decennial 2020 Census Redistricting data (PL94-171)
mkdir -p /tmp/census/dec2020_pl94
cd /tmp/census/dec2020_pl94
...
wget --recursive --continue --accept=*.zip --reject=us2020.npl.zip \
     ...
     -e robots=off \
     --directory-prefix=/tmp/census/dec2020_pl94 \
