#!/bin/bash
# https://raw.githubusercontent.com/censusreporter/census-postgres-scripts/master/13_import_blocks_2020.sh
...
for i in /tmp/census/blocks2020/TABBLOCK20 # not a list but easier to keep it like other tiger importers
do
