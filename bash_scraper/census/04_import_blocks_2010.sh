#!/bin/bash
# https://raw.githubusercontent.com/censusreporter/census-postgres-scripts/master/13_import_blocks_2010.sh
...
for i in /tmp/census/blocks2010/TABBLOCK10 # not a list but easier to keep it like other tiger importers
do
