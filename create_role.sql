...
CREATE ROLE scraper_bot;
GRANT CONNECT ON DATABASE parcels to scraper_bot;
GRANT USAGE, CREATE ON SCHEMA parcel_data to scraper_bot;
GRANT SELECT, INSERT, UPDATE, DELETE ON ALL TABLES IN SCHEMA parcel_data TO scraper_bot;
...
ALTER role parcel_data WITH LOGIN;
